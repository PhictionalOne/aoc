...
main = do
  ...
  print "Part 1: How many total Calories is [the Elf with the most Calories] carrying?"
  print $ partOne puzzle
  print "Part 2: How many Calories are [the 3 top Elves] carrying in total?"
